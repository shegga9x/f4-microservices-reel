...
import com.f4.reel.client.auth.HttpBasicAuth;
import com.f4.reel.client.auth.HttpBearerAuth;
import com.f4.reel.client.auth.ApiKeyAuth;
import com.f4.reel.client.ApiResponseDecoder;
